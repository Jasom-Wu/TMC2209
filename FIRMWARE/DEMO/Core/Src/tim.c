...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PB4(NJTRST)     ------> TIM3_CH1
    */
    GPIO_InitStruct.Pin = M2STEP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(M2STEP_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PB8     ------> TIM4_CH3
    */
    GPIO_InitStruct.Pin = M1STEP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
    HAL_GPIO_Init(M1STEP_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM23_MspPostInit 0 */
    ...
    PG13     ------> TIM23_CH2
    */
    GPIO_InitStruct.Pin = M3STEP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF13_TIM23;
    HAL_GPIO_Init(M3STEP_GPIO_Port, &GPIO_InitStruct);
